...
var user = 'CortexCouncilWorkspace'; // alternatively, manually enter a different user than yourself using var user = 'alternate_username';
...
function genRepo(user) {
    ...
    if (testuser.test(user) == false || user == "" || user == null) {
        ...
        var requestURL = 'https://api.github.com/orgs/' + user + '/repos';
            ...
            .done(function () {
                ...
                if (!Array.isArray(request) || !request.length) {
                    ...
                    for (i = 0; i < request.length; i++) {
                        ...
                        $("#repo-box").append("<a href='" + repo_url + "' target='_blank'><div class='repo-item'><h1 class='title' style='color:white'>" +
                            username + "/" +
